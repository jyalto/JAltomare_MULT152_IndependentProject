...
Shader "Toon/TAI_CustomToon"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 CalculateShadowMask216_g1( half2 LightmapUV )
			{
			...
			float3 AdditionalLightsLambertMask12x( float3 WorldPosition, float3 WorldNormal, float4 ShadowMask )
			{
				float3 Color = 0;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 WorldPosition130_g1 = worldPosValue184_g1;
				...
				float3 WorldNormal130_g1 = worldNormalValue185_g1;
				half2 LightmapUV216_g1 = (IN.ase_texcoord6.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				half4 localCalculateShadowMask216_g1 = CalculateShadowMask216_g1( LightmapUV216_g1 );
				float4 shadowMaskValue182_g1 = localCalculateShadowMask216_g1;
				float4 ShadowMask130_g1 = shadowMaskValue182_g1;
				float3 localAdditionalLightsLambertMask12x130_g1 = AdditionalLightsLambertMask12x( WorldPosition130_g1 , WorldNormal130_g1 , ShadowMask130_g1 );
				float3 bakedGI32 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, ase_worldNormal);
				Light ase_mainLight = GetMainLight( ShadowCoords );
				MixRealtimeAndBakedGI(ase_mainLight, ase_worldNormal, bakedGI32, half4(0,0,0,0));
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
				float4 ase_lightColor = float4( _MainLightColor.rgb / ase_lightIntensity, ase_lightIntensity );
				float2 uv_TextureSample = IN.ase_texcoord6.zw * _TextureSample_ST.xy + _TextureSample_ST.zw;
				...
				#endif
				float dotResult8 = dot( ase_worldNormal , _MainLightPosition.xyz );
				...
				float3 Color = ( ( float4( ( ( localAdditionalLightsLambertMask12x130_g1 + bakedGI32 ) * ase_lightColor.rgb * ase_lightColor.a ) , 0.0 ) * tex2DNode18 ) + ( ( tex2DNode18 * float4( staticSwitch16 , 0.0 ) ) * ( tex2D( _TextureRamp, temp_cast_3 ) * ( temp_output_12_0 * max( max( break5.x , break5.y ) , break5.z ) ) ) ) ).rgb;
				float Alpha = 1;
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-947.1844,-122.4824;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;45;-1368.456,-254.8261;Inherit;False;SRP Additional Light;-1;;1;6c86746ad131a0a408ca599df5f40861;8,212,0,6,1,9,0,23,0,24,1,142,1,168,1,154,1;6;2;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;15;FLOAT3;0,0,0;False;14;FLOAT3;0,0,0;False;18;FLOAT;0.5;False;32;FLOAT4;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;46;-1087.089,-184.6769;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;36;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Toon/TAI_CustomToon;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;21;Surface;0;0;  Blend;0;0;Two Sided;1;0;Forward Only;0;638472620355415109;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=CC6BB672E03741971E3FBB528DC28C513EE8BA45